...
import { isRippleDesktop } from "../../../config/product";
...
const defaultConfig = {
  theme: {
    ...
    leftHeader: {
      logo: "",
      title: isRippleDesktop ? "AxiMate Ripple" : "CoPaw Console",
    },
  },
  sender: {
    attachments: true,
  ...
  welcome: {
    ...
    avatar: `${import.meta.env.BASE_URL}${
      isRippleDesktop ? "ripple-symbol.svg" : "assistant-avatar.svg"
    }`,
    prompts: [
      {
