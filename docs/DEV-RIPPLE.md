...
- **`integrations/copaw/extensions/`**：放 **AxiMate 自有的 skill 模板、说明或脚本**；实际加载路径需按 CoPaw 的 working dir / 配置把文件放到 CoPaw 能扫描的位置，或用手动复制、符号链接（以 [Config](https://copaw.agentscope.io/docs/config) 为准）。
